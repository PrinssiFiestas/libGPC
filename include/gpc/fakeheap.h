...
void* fakeHeapMalloc(size_t size, struct FakeHeapCallData);
void  fakeHeapFree(void* p, struct FakeHeapCallData);
void* fakeHeapCalloc(size_t nmemb, size_t size, struct FakeHeapCallData);
void* fakeHeapRealloc(void* p, size_t size, struct FakeHeapCallData);
