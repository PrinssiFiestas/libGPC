...
#  define gp_atomic_load_explicit_uz(A, C, MO)          gp_atomic_load_explicit_u32(A, C, MO)
...
#  define gp_atomic_load_explicit_iz(A, C, MO)          gp_atomic_load_explicit_i32(A, C, MO)
...
#  define gp_atomic_load_explicit_iz(A, C, MO)          gp_atomic_load_explicit_i64(A, C, MO)
...
#define gp_atomic_load_explicit(A, C, MO)          atomic_load_explicit(&(A)->atomic, C, MO)
...
#define gp_atomic_load_explicit(A, C, MO)      __atomic_load_n(&(A)->nonatomic, C, MO)
